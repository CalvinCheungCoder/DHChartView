...
//    _ChartView.maskBottomColor = [UIColor colorWithRed:81/255.0 green:183/25.0 blue:200/255.0 alpha:0.0];
//    _ChartView.tipsTextColor = [UIColor whiteColor];
//    _ChartView.tipsTextBackColor = [UIColor redColor];
//    _ChartView.tipsTextLayerColor = [UIColor redColor];
